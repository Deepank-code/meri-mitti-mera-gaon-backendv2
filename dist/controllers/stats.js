...
export const getDashboardStats = TryCatch(async (req, res, next) => {
    ...
    if (myCache.has("admin-stats"))
        ...
        const latestTransactionsPromise = Order.find({})
            ...
            .limit(4);
        const [thisMonthProducts, thisMonthOrders, thisMonthUsers, lastMonthOrders, lastMonthProducts, lastMonthUsers, productCount, usersCount, allOrders, lastSixMonthOrder, categories, femaleUserCount, latestTransactions,] = await Promise.all([
...
export const getPieChart = TryCatch(async (req, res, next) => {
    ...
    if (myCache.has("admin-pie-charts"))
        ...
        const [processingOrder, shippedOrder, deliveredOrder, categories, productCount, productOutStock, allOrders, allUsers, adminUsers, customerUsers,] = await Promise.all([
